...
extension WednesViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    if indexPath.row == 0 {
      cell.titleLabel.text = CafeteriaCrawlManager.cafeteriaTypeArray[4]
      cell.menuNameLabel.text = CafeteriaCrawlManager.cafeteriaMenuNameArray[4]
      cell.menuPriceLabel.text = CafeteriaCrawlManager.cafeteriaMenuPriceArray[4]
    }
    else {
      cell.titleLabel.text = CafeteriaCrawlManager.cafeteriaTypeArray[5]
      cell.menuNameLabel.text = CafeteriaCrawlManager.cafeteriaMenuNameArray[5]
      cell.menuPriceLabel.text = CafeteriaCrawlManager.cafeteriaMenuPriceArray[5]
    }
  ...
  func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
    return CafeteriaCrawlManager.cafeteriaDayArray[2]
  }
