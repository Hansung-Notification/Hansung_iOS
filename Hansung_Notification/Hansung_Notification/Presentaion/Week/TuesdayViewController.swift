...
extension TuesdayViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    if indexPath.row == 0 {
      cell.titleLabel.text = CafeteriaCrawlManager.cafeteriaTypeArray[2]
      cell.menuNameLabel.text = CafeteriaCrawlManager.cafeteriaMenuNameArray[2]
      cell.menuPriceLabel.text = CafeteriaCrawlManager.cafeteriaMenuPriceArray[2]
    }
    else {
      cell.titleLabel.text = CafeteriaCrawlManager.cafeteriaTypeArray[3]
      cell.menuNameLabel.text = CafeteriaCrawlManager.cafeteriaMenuNameArray[3]
      cell.menuPriceLabel.text = CafeteriaCrawlManager.cafeteriaMenuPriceArray[3]
    }
  ...
  func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
    return CafeteriaCrawlManager.cafeteriaDayArray[1]
  }
